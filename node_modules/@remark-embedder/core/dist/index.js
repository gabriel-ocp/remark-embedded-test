      ...
      try {
        ...
        if (!html) {
          try {
            ...
            await (cache == null ? void 0 : cache.set(cacheKey, html)); // optional handleHTML transform function
        ...
        const htmlElement = await htmlToHast(html); // set the parentNode.data with the necessary properties
